...
public class BookController {
    ...
    public ResponseEntity<Book> issueBook(@RequestBody IssueBookRequest bookRequest) {
        return new ResponseEntity<>(issueBookService.issueBook(bookRequest.getBookId(), bookRequest.getBookId(), bookRequest.getConfirmationCode(),bookRequest.getExpiryDate()), HttpStatus.OK);
    }
